#!/bin/bash
savedir="/home/projects/ku_00067/scratch/mbl-intrinsicdimension/paper_data_v2/"

# Use batch for L=8, bc a single run over all Ws takes just a second
L=8
for i in `seq 0 1000 99999`
do
	Ss=$i
        let Se=$i+1000
...
#for i in `seq 30 99`
#do
#	for W in 1.0   1.2  1.4  1.6  1.8  2.0   2.2  2.4  2.6  2.65 2.7  2.75 2.8  2.85 2.9  2.95 3.0   3.05 3.1  3.15 3.2  3.25 3.3  3.35 3.4  3.45 3.5  3.55 3.6  3.65 3.7  3.75 3.8  3.85 3.9  3.95 4.0   4.05 4.1  4.15 4.2  4.25 4.3  4.35 4.4  4.45 4.5  4.7  4.9  5.1  5.3  5.5  5.7  5.9  6.1
#	do
#		if test -f "/home/projects/ku_00067/scratch/mbl-intrinsicdimension/paper_data/2nn_L_18_seed_${i}_W_${W}.npy"; then
#    			echo "Skipping"
#		else
#			qsub -l walltime=144:00:00,mem=160gb -v output_path=$savedir,L=$L,S=$i,W=$W -N 2NN-L-$L-S-$i-W-$W controlscript_for_W.pbs
#		fi
#	done
#done
